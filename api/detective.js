...
판정 기준: 공개된 사정을 반영한 구체적 행동이면 ok=true. 사정과 무관하거나('더 열심히 시킨다'), 데이터만 보고 벌·압박부터 가하거나, 막연한 일반론('잘 지도한다')이면 ok=false.
comment: 2문장 이내, 존댓말. true면 행동의 좋은 점을 짚고, false면 사정의 어떤 부분을 놓쳤는지 알려 줄 것.
