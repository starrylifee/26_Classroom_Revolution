...
세 가지를 각각 판정하세요. 답변에 적혀 있다면 표현이 소박해도 인정하되, 답변에 없는 내용을 좋게 추측해 채워 주면 안 됩니다. 무의미한 글자 나열이나 데이터와 무관한 내용이면 세 항목 모두 false:
...
- checks: 판단 전에 추가로 확인할 것(관찰, 대화, 다른 데이터 등)을 제시했는가 — '기록을 열어 본다', '본인과 이야기한다', '더 지켜본다'처럼 확인 행동이 하나라도 적혀 있으면 true
